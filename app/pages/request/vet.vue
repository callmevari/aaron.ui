...
<template>
  <div class="min-h-screen min-h-[100dvh] flex flex-col bg-gray-50 dark:bg-gray-900 md:bg-white md:dark:bg-gray-800 md:mx-24 lg:mx-48 pb-24">
    ...
    <!-- Bottom Action (only shown when there's an active/past request) - positioned above navbar (h-16 + safe area) -->
    <div v-if="storeActiveVetRequest" class="fixed left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-4 md:left-24 md:right-24 lg:left-48 lg:right-48 z-40" style="bottom: calc(4rem + env(safe-area-inset-bottom, 0px))">
